...
static cl::OptionCategory SDKCFGCategory("SDK CFG Options", "");
...
int main(int argc, char *argv[]) {
  revng::InitRevng X(argc, argv, "", { &SDKCFGCategory });
  applyResourceRoots();
  ...
  for (const MetaAddress &Entry : Selected) {
    ...
    std::string Name = "cfg/" + safeFilename(Entry) + ".yml";
